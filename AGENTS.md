...
### Current Sources
- `ue50-docs` (292 files) → `.Codex/knowledge/ue50-docs/`
- `ue51-docs` (284 files) → `.Codex/knowledge/ue51-docs/`
- `ue52-docs` (333 files) → `.Codex/knowledge/ue52-docs/`
- `ue53-docs` (29 files) → `.Codex/knowledge/ue53-docs/`
