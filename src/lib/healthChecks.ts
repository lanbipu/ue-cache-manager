...
export const HEALTH_CHECKS = [
  ...
  { id: "ntfs_perm", shortLabel: "ACL", label: "NTFS access", description: "Filesystem and ACL prerequisites are available.", symptom: "Writes fail after network access succeeds.", remediation: "Fix NTFS permissions on the cache root." },
  ...
  { id: "rs_service", shortLabel: "RS", label: "RenderStream service", description: "Detect RenderStream services and risky account configurations.", symptom: "Service runs as LocalSystem; user-level config invisible.", remediation: "Move config to Machine-scope env or switch service account." },
